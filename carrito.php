  ...
  <div class="content-wrapper">
    ...
    <div class="content-header hero-image" >
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-white">Carrito</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid" >
          ...
          <div class="col-12">
            <div class="card card-primary">
              <div class="card-header" >
                <h3 class="card-title">Lista de Carrito</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php 
                   ...
                   $carrito = new ControladorCarrito();
                    $list=  $carrito -> ctrListarCarrito(1,1000);
                    
                    while (count($list)>0){
                      $Carrito = array_shift($list);
                      echo "<tr>";
                      $Did = array_shift($Carrito);
                      echo "<td>".$Did."</td>";
                      $Dmonto = array_shift($Carrito);
                      echo "<td>".$Dmonto."</td>";
                     /* $Dimagen = array_shift($Vehiculo);
                      ...
                      echo '<td>
                              <button class="btn" onclick="saveData('.$Did.',\''.$Dmonto.'\')"><i class="fas fa-edit"></i> Editar</button>
                              <button class="btn" onclick="updateStatus('.$Did.')"><i class="far fa-'.$DestadoIco.'"></i>'.$Destadobtn.'</button>
                     
                              <form action="deletecarrito.php" class="d-inline" method="post" >
                              <input type="hidden" id="idcarrito" name="idcarrito" value="'.$Did .'" />
        ...
        <div class="card card-primary">
              <div class="card-header">
                ...
                <button id="nuevoalmacen" class="btn float-right" onclick="newUser()" > <i class="fas fa-user-plus"></i> Nuevo vehiculo</button>
              ...
              <form role="form"  enctype="multipart/form-data" method="post"   >
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputNombre">Monto</label>
                    <input type="text" class="form-control" id="monto" name="monto" placeholder="Ingrese el nombre del almacen">
                  </div>
                ...
                <div class="card-footer">
                  <?php
                    ...
                    $resp= $carrito -> ctrRegistroCarrito();
